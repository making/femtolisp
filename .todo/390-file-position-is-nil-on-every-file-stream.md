...
Consumers designed around the gap (2026-09-03): the checkpoint readers
(`.kb/checkpoint-readers.md` safetensors, `.kb/gguf.md` GGUF; `.todo/675`, `.todo/673`) walk their files front to back and pass over
