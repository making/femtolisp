...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 188,829 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 189,197 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 419,727 |
| zlib | `--optimize` | core (command) | Preview 1 | 152,275 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 124,613 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 128,567 |
