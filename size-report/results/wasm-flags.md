...
| zlib | `--optimize=off` | core (command) | Preview 1 | 420,899 |
| zlib | `--optimize` | core (command) | Preview 1 | 153,062 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 125,400 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 129,397 |
