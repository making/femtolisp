...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 201,582 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 201,950 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 5,212 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,811 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 5,954 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 445,101 |
| zlib | `--optimize` | core (command) | Preview 1 | 158,926 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 131,241 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 135,250 |
