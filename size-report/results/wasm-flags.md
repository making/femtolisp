...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 390,608 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 390,976 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 5,227 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,826 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 635,697 |
| zlib | `--optimize` | core (command) | Preview 1 | 159,922 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 132,237 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 136,427 |
