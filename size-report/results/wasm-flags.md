...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 189,072 |
| hello_world | `--optimize` | core (command) | Preview 1 | 597 |
| hello_world | `--optimize=size` | core (command) | Preview 1 | 597 |
| hello_world | `--component --optimize=size` | component (command) | Preview 3 | 1,753 |
| hello_world (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 406 |
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 189,440 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 5,213 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,812 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 5,940 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 420,906 |
| zlib | `--optimize` | core (command) | Preview 1 | 153,070 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 125,408 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 129,405 |
