...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 230,150 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 230,518 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 473,677 |
| zlib | `--optimize` | core (command) | Preview 1 | 158,942 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 131,257 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 135,444 |
