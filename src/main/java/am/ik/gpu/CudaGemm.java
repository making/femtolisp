...
final class CudaGemm implements GpuDevice {
	 ...
	 * (48 SMs; {@code .todo/artefacts/123-gpu-acceleration/gemm-tile-probe.cu}): the
	 * 128x128 tile is 2.2-4x the 16x16 kernel once its grid holds about half the SMs -- a
