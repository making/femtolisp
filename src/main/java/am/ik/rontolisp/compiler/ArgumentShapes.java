...
public final class ArgumentShapes {
	...
	private static final Set<String> UNMODELLED_BINDING_HEADS = Set.of(LispNames.MULTIPLE_VALUE_BIND,
			...
			LispNames.PPRINT_LOGICAL_BLOCK, LispNames.DO_EXTERNAL_SYMBOLS, LispNames.DO_SYMBOLS,
			LispNames.DO_ALL_SYMBOLS, LispNames.MACROLET, LispNames.SYMBOL_MACROLET);
