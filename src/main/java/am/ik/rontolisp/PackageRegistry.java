...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.FIND_SYMBOL_STATUS, LispNames.SUBTYPEP_VALID, LispNames.WARN_INTERNAL, LispNames.SCHAR_SET,
			...
			LispNames.CHAR_FOLD_CHAIN, LispNames.SET_XOR_MATCH, LispNames.SUBST_WALK, LispNames.RD_DATUM,
			LispNames.RD_DISPATCH, LispNames.RD_SKIP, LispNames.RD_SKIP_LINE, LispNames.RD_BLOCK_COMMENT,
			LispNames.RD_LIST, LispNames.RD_STRING, LispNames.RD_BARS, LispNames.RD_TOKEN_REST,
			LispNames.RD_CHAR_LITERAL, LispNames.RD_SHARP, LispNames.RD_WHITESPACE_P, LispNames.RD_TERMINATING_P,
			...
			LispNames.HB_GUARD_INTERNAL, LispNames.HC_MATCH_INTERNAL, LispNames.PROGRAM_ERROR_INTERNAL,
			LispNames.HANDLERS_RAN_VAR, LispNames.HANDLER_CLUSTERS_VAR, LispNames.RESTART_CLUSTERS_VAR,
			...
			LispNames.PRINT_CASED_INTERNAL, LispNames.PRINT_CASE_FOLD_INTERNAL,
