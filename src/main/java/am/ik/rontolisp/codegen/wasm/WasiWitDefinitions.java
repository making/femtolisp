...
final class WasiWitDefinitions {
	...
	private static WitItem wasiCliV030() {
		return packageBlock("wasi", "cli", "0.3.0",
				...
				iface("environment", func("get-environment", funcType(list(tuple(string(), string())))),
						func("get-arguments", funcType(list(string())))),
	...
	private static WitItem wasiFilesystemV030() {
		return packageBlock("wasi", "filesystem", "0.3.0", iface("types",
				use(ref("wasi", "clocks", "system-clock", "0.3.0"), useName("instant")),
				resource("descriptor",
						func("read-via-stream",
								funcType(tuple(stream(u8()), future(result(null, named("error-code")))),
						...
						func("read-directory",
								funcType(tuple(
										stream(named("directory-entry")), future(result(null, named("error-code")))))),
						func("create-directory-at",
								asyncFuncType(result(null, named("error-code")), param("path", string()))),
						func("stat", asyncFuncType(result(named("descriptor-stat"), named("error-code")))),
						...
						func("rename-at",
								asyncFuncType(result(null, named("error-code")), param("old-path", string()),
										param("new-descriptor", borrow("descriptor")), param("new-path", string()))),
						func("unlink-file-at",
								asyncFuncType(result(null, named("error-code")), param("path", string())))),
				...
				typeAlias("link-count", u64()),
				record("descriptor-stat", field("type", named("descriptor-type")),
						field("link-count", named("link-count")), field("size", named("filesize")),
						field("data-access-timestamp", option(named("instant"))),
						field("data-modification-timestamp", option(named("instant"))),
						field("status-change-timestamp", option(named("instant"))))),
