 ...
 * }</pre>
 *
 * {@code .todo/artefacts/488-the-fused-bfloat16-gemv-kernels/bench.sh} runs both and
 * labels the output; the numbers it produced are recorded in that directory's
 * {@code README.md}.
 */
